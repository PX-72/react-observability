  ...
  return (
    <form onSubmit={onSubmit} style={{ display: "grid", gap: 12, maxWidth: 560 }}>
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
        ...
        {!validation.isValid ? <span style={{ fontSize: 12, color: "var(--muted)" }}>Fix validation errors to submit.</span> : null}
      </div>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        ...
        <div style={{ fontFamily: "ui-monospace, SFMono-Regular, Menlo, monospace", fontSize: 12 }}>
          {traceparentForAttempt ? traceparentForAttempt : <span style={{ color: "var(--muted)" }}>—</span>}
        </div>
        <div style={{ fontSize: 12, color: "var(--muted)" }}>
